          ...
          <div className="relative">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  {customerData.subscription_status !== "active" ? <div className="text-xs text-gray-400">Free Member</div>
              ...
              <ChevronDown
                size={16}
                className={`text-gray-400 transform transition-transform duration-200 ${showUserDropdown ? "rotate-180" : ""
                  }`}
              />
            </button>
            ...
            {showUserDropdown && (
              <div className="absolute bottom-full left-0 right-0 mb-2 bg-gray-800 rounded-lg overflow-hidden shadow-lg">
                {customerData.subscription_status !== "active" && <button
