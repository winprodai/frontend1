...
export const stripeConfig: StripeConfig = {
  ...
  prices: {
    monthly: {
      pro: 'price_1R7ncpGGWIauWKc9RjqVeBXW' // Replace with your Stripe monthly price ID
    },
    yearly: {
      pro: 'price_1R7ncWGGWIauWKc9nFg5ovS8' // Replace with your Stripe yearly price ID
    }
  }
};
